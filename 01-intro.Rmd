...
Dentro de la estadistica económica, los índices simples se clasifican como: *Índice de precios, cantidades y valores.*
...
Hablaremos de *índices complejos* cuando queremos comparar  magnitudes para grandes grupos de bienes y se desea recoger la evolución conjunta de los precios, las cantidades o los valores de una cantidad de bienes o productos.

Distinguiremos dos tipos de índices complejos:

* Índice complejo **no ponderado**, que dan igual importancia a todos los bienes.

* Índice complejo **ponderado**, donde cada bien lleva asociado un peso o ponderación.

***1. Índice complejo no ponderado (Media aritmética de índices simples)*** 

$$ \overline{I}_{t/0}=\frac{1}{N}\sum^{N}_{i=1}I_i $$
donde $N$ es el número de productos, e $I_i=\frac{x_{i/t}}{x_{i/0}}$, es decir el índice simple de la variable $x$ en el periodo $t$.
...
***1. Índice complejo ponderado (Media aritmética ponderada)*** 
...
$$ \overline{I}_{t/0}=\frac{\sum^{N}_{i=1}w_iI_i}{\sum^{N}_{i=1}w_i} $$
**Ejemplo.**
