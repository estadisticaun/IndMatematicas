...
Un índice es una estadística compuesta, es decir, es basada en múltiples elementos de datos, en otras palabras, un índice es una medida compuesta que agrega múltiples indicadores. Los índices, también conocidos como *indicadores compuestos*, resumen y clasifican observaciones específicas, generalmente en la escala ordinal.
...
|Ejemplo de escala ordinal usando la variable estrato $A_2$|
|----|----|
|**Estrato**|**Puntaje**|
|$1$|$00$|
|$2$|$13$|
...
> Para más información sobre la asignación del PBM consulte en siguiente documento. [PBMunal](http://www.legal.unal.edu.co/rlunal/home/doc.jsp?d_i=34298)

La OCDE (Organización para la Cooperación y el Desarrollo Económicos) y el Centro Común de Investigación de la Comisión Europea publicaron conjuntamente un manual para la construcción de indicadores compuestos en 2008. El manual, respaldado oficialmente por el comité estadístico de alto nivel de la OCDE, describe diez pasos recurrentes para la elaboración de un índice: 
...
Es una cifra de datos económicos que refleja el precio o la cantidad en comparación con un valor estándar o base. Particularmente, el número índice recoge la evolución relativa en el periodo $t$ de una magnitud económica (precios, producciones, …) de un conjunto de bienes o productos respecto al período base ó de referencia $0$. Los números índice se utilizan especialmente para comparar la actividad empresarial, el costo de vida y el empleo.  
...
>Estos índices representan una medida que se obtiene mediante la agregación adecuada de un conjunto de indicadores sociales. Gran parte de los datos están representados en varios índices como el índice de brecha de género, el índice de desarrollo humano, el índice de bienestar social, entre otros.

Según Earl Babbie, los elementos de los índices suelen ponderarse por igual, a menos que existan razones en contra (por ejemplo, si dos elementos reflejan esencialmente el mismo aspecto de una variable, podrían tener un peso de 0,5 cada uno). 
...
*Indicador 1: Porcentaje de estudiantes en nivel insuficiente*

|Grado|Área|2015|2016|
|:---------------:|:--------------:|:-------:|:-------:|
...
*Indicador 2: Porcentaje de estudiantes en nivel avanzado*
...
*Indicador 3: Promedio de los resultados obtenidos en las últimas pruebas*
...
+ Desempeño insuficiente (DI): Se estima calculando la suma de la [tasa de variación](https://estadisticaun.github.io/IndMatematicas/1-4-tasas.html#tasa-de-variaci%C3%B3n) con respecto al año anterior del porcentaje de estudiantes en el nivel insuficiente.
...
#### Puntaje Básico de Matrícula (PBM)
En la parte inicial del capítulo explicamos en que consistía el [PBM](https://estadisticaun.github.io/IndMatematicas/1-6-%C3%ADndice.html). A continuación haremos el ejercicio de calcular dicho puntaje para un aspirante de pregrado de la universidad. Para ello, recolectamos los siguientes datos.
...
Empezaremos determinando el indicador $A_1$ 

 ![Recuperado de http://www.legal.unal.edu.co/rlunal/home/doc.jsp?d_i=34298](C:/Users/USUARIO/Pictures/pension.png){width=800px}
 
de donde $A_1=500\times 0,03=15$. Para el indicador $A_2$ la [tabla estrato](https://estadisticaun.github.io/IndMatematicas/1-6-%C3%ADndice.html) nos indica que $A_2=30$. Siguiendo con el indicador $A_3$ se asigna mediante la  expresión 
...
![Recuperado de http://www.legal.unal.edu.co/rlunal/home/doc.jsp?d_i=34298](C:/Users/USUARIO/Pictures/b1.png){width=400px}
![Recuperado de http://www.legal.unal.edu.co/rlunal/home/doc.jsp?d_i=34298](C:/Users/USUARIO/Pictures/b2n.png){width=400px}
![Recuperado de http://www.legal.unal.edu.co/rlunal/home/doc.jsp?d_i=34298](C:/Users/USUARIO/Pictures/b3.png){width=400px}

![Recuperado de http://www.legal.unal.edu.co/rlunal/home/doc.jsp?d_i=34298](C:/Users/USUARIO/Pictures/b4.png){width=400px}

Como lo indica las tablas, se obtiene los puntajes $B_1=0,95$, $B_2=0,80$, $B_3=1$ y $B_4=1$ respectivamente. Utilizando a formúla 
